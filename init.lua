...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>pf', builtin.find_files, { desc = 'Search Whole [P]roject [F]iles' })
      vim.keymap.set('n', '<leader>p', builtin.git_files, { desc = '[S]earch Git Files in [P]roject' })
  ...
  -- Plugin to show a bar at the top with open buffers
  {
    'romgrk/barbar.nvim',
    dependencies = {
